...
extern pdc_obj_cache *obj_cache_list, *obj_cache_list_end;

extern pthread_mutex_t pdc_obj_cache_list_mutex;
extern pthread_t       pdc_recycle_thread;
extern pthread_mutex_t pdc_cache_mutex;
extern int             pdc_recycle_close_flag;
