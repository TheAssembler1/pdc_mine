...
extern pdc_transfer_request_status *transfer_request_status_list;
extern pdc_transfer_request_status *transfer_request_status_list_end;
extern pthread_mutex_t              transfer_request_status_mutex;
extern pthread_mutex_t              transfer_request_id_mutex;
extern uint64_t                     transfer_request_id_g;
extern hg_handle_t                  close_all_server_handle_g;
